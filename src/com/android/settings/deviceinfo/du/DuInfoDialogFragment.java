...
public class DuInfoDialogFragment extends InstrumentedDialogFragment {

    private static final String TAG = "DuInfoDialog";
    ...
    public static void show(Fragment host) {
        ...
        if (manager.findFragmentByTag(TAG) == null) {
            final DuInfoDialogFragment dialog = new DuInfoDialogFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        final AlertDialog.Builder builder = new AlertDialog.Builder(getActivity())
                .setTitle(R.string.du_title)
                .setPositiveButton(android.R.string.ok, null /* listener */);

        mRootView = LayoutInflater.from(getActivity()).inflate(
                R.layout.dialog_du_info, null /* parent */);
